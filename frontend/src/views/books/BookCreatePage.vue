<template>
  <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <!-- Заголовок -->
    <div class="mb-8">
      <h1 class="text-3xl font-bold text-gray-900">Добавление новой книги</h1>
...
const handleSubmit = async () => {
  try {
    ...
    await booksStore.createBook(submitData)
    uiStore.success('Книга успешно добавлена')
    ...
    if (err instanceof yup.ValidationError) {
      ...
      uiStore.error('Ошибка при создании книги')
    }
  } finally {
...
onMounted(() => {
  fetchData()
  // Добавляем одного автора по умолчанию
